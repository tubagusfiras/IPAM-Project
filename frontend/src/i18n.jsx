...
const EN = {
  ...
  "login.subtitle": "Sign in to manage your network",
...
const ID = {
  ...
  "login.subtitle": "Masuk untuk mengelola jaringan Anda",
  "login.username": "Username",
  ...
  "login.scanning": "Autentikasi…",
  "login.success": "Selamat datang!",
  "login.fillAll": "Harap isi semua field",
